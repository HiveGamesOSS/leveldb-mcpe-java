...
public class NativeInteropTest
{
            ...
            throws IOException
    {
        ...
        iq80factory.destroy(rc, new Options().compressionType(CompressionType.SNAPPY).createIfMissing(true));
        rc.mkdirs();
        return rc;
    }
    ...
    public void crud(DBFactory firstFactory, DBFactory secondFactory)
            throws IOException, DBException
    {
        Options options = new Options().compressionType(CompressionType.SNAPPY).createIfMissing(true);
